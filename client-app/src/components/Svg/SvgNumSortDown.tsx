const SvgNumbSortDown: React.FC<{ className: string }> = ({ className }) => (
   <svg
      aria-hidden='true'
      focusable='false'
      data-prefix='fas'
