...
const NavSecondary: React.FC = () => {
   ...
   return (
      <nav className='h-20 w-screen absolute top-0 left-1/2 -translate-x-1/2 flex items-center justify-around z-20 lg:h-[4.5rem] lg:fixed lg:bg-custom-navy-600 dark:lg:bg-custom-navy-400 lg:shadow-lg lg:px-10  2xl:h-[5rem]'>
         {/* back button */}
         <div>
            <button
               role='link'
